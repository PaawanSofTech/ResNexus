                ...
                <div class="widget-content">
                  <div class="padd" style="height:650px">
                    ...
                    <h2 style="font-size: 20px; text-align: center;">
                      ...
                      <th style="text-transform: capitalize;"><?php echo $row['r_status'];?></th>
                    </h2>

                      <p style="font-size: 15px; text-align: center;"><em>Reminder: Please print your reservation summary and take note of your reservation code for reservation inquiry.</em></p>
                    </div>
