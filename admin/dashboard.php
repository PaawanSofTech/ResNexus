...
<div class="navbar navbar-fixed-top bs-docs-nav" role="banner">
    ...
    <div class="conjtainer">
      ...
      <a href="index.html" class="navbar-brand hidden-lg">Hotel Restaurant</a>
    </div>
...
<div class="span10">
  <div class="contentheader">
      <ul class="breadcrumb">
      <font style=" font:bold 44px 'Aleo'; text-shadow:10px 10px 50px #000; color:black;"><center>Restaurant & Recipt Nexus</center></font>
<div id="mainmain">
     ...
     <div id="jssor_1" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 1300px; height: 500px; overflow: hidden; visibility: hidden;">
        ...
        <div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 0px; width: 1300px; height: 500px; overflow: hidden;">
            <div data-p="225.00">
                <img data-u="image" src="img/Hotel.jpg" />
